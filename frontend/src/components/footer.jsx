            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        ...
                        <a className="hover:text-slate-500 transition" href="#">Careers<span className="text-xs text-white bg-indigo-600 rounded-xl ml-2 px-2 py-1">We’re hiring!</span></a>
                ...
                <div>
                    ...
                    <div className="text-sm space-y-6 max-w-sm">
                        ...
                        <div className="flex items-center justify-center gap-2 p-2 rounded-4xl bg-slate-900">
                            <input className="outline-none w-full max-w-64 py-2 rounded px-2" type="email" placeholder="Enter your email" />
                            <button className="bg-indigo-600 px-4 py-2 text-white rounded-2xl">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
            <p className="py-4 text-center border-t mt-6 border-slate-700">
                Copyright 2025 © <a href="https://prebuiltui.com?utm_source=agentix">Designify</a> All Right Reserved.
            </p>
        </motion.footer>
    );
};