    ...
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                ...
                <span>Generate your Youtube Thumbnail</span>
            </motion.a>
            <motion.h1 className="text-center text-5xl leading-[68px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-3xl"
                initial={{ y: 50, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ type: "spring", stiffness: 240, damping: 70, mass: 1 }}
            >
                Generate thumbnails instantly with{" "}
            ...
            <motion.p className="text-center text-base max-w-lg mt-2"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Our platform built for creators who want more clicks, not more work.
            </motion.p>
            ...
            >
                <button onClick={()=> navigate('/generate')} className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 transition text-white active:scale-95 rounded-3xl px-7 h-11">
                    Generate Now
                    <ArrowRight className="size-5" />
                </button>
                <button className="border border-slate-400 active:scale-95 hover:bg-white/10 transition rounded-3xl px-8 h-11">
                    Demo Thumbnails
                </button>
            </motion.div>
            <TiltedImage />
